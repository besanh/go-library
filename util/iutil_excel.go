...
func (i *Util) HandleExcelStreamWriter(headers, rows [][]string, mergedColumns ...string) (buffer *bytes.Buffer, err error) {
...
func (i *Util) HandleCSVStreamWriter(fileName string, headers [][]string, rows [][]string, mergedColumns ...string) (buffer *bytes.Buffer, err error) {
