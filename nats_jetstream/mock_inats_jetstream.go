...
func (_m *MockINatsJetstream) Connect() error {
	ret := _m.Called()
...
func (_c *MockINatsJetstream_Connect_Call) Return(_a0 error) *MockINatsJetstream_Connect_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *MockINatsJetstream) Ping() {
	_m.Called()
}
